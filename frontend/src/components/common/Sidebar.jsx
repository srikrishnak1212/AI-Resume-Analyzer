...
/**
 * Sidebar — Left navigation sidebar. Responsive and collapses on mobile/tablet.
 *
 * Reference: UI-Guide.md §6.2 (Sidebar), §9 (Responsiveness Summary)
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      >
        {/* Header - visible only on mobile to close the drawer */}
            ...
            <div className="space-y-1">
              {futureNavItems.map((item) => (
                <div
                  ...
                  title="This feature will be unlocked in the next phase."
                >
                  <item.icon className="h-5 w-5 shrink-0" strokeWidth={1.8} />
        ...
        <div className="border-t border-border p-4">
          <div className="rounded-lg bg-surface-alt p-3.5 text-center">
            ...
            <p className="text-[11px] text-text-muted mt-0.5">Read our implementation docs.</p>
          </div>
        </div>
      </aside>
    </>
